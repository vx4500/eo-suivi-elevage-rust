...
- [x] Afficher TMP et données techniques d'abattage par bande — déjà livré :
      ...
      liste, corrigée ici.
- [ ] Afficher stade, emplacement actuel et effectif réel des porcs. Partiel :
      la fiche bande affiche déjà l'effectif réel (`suivi_porcs.presents`) et
      un historique des derniers emplacements, mais pas le stade actuel ni
      une vue « emplacement actuel » consolidée (case par case) pour la
      bande. Reste à faire.
